...
from src.tools.indicators import get_volume_profile
...
async def journaler_node(state: State, config: RunnableConfig):
    ...
    tools = [write_daily_journal, list_journal_entries, read_journal_entry, get_journal_folder, set_journal_folder, get_daily_blotter, get_stock_quote, log_feedback, run_smc_analysis, get_raw_smc_tables, get_volume_profile]
