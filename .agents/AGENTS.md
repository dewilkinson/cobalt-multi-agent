...
- Only run the end-of-day script (scripts/run_end_of_day.py) with explicit user permission; do not initiate it automatically.
- Do not execute git push or push changes to GitHub/remote repositories without explicit user permission.
