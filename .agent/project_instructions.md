...
## CRITICAL RESTRICTION: DO NOT PUSH AUTOMATICALLY
Do NOT run git push automatically at the end of task execution. Only execute git push when explicitly commanded by the user.
