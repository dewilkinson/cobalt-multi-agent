...
closed_2025 = parse_atp_closed_positions('c:/github/cobalt-multi-agent/data/dropzone/2025.csv').get(account, [])
closed_ytd = parse_atp_closed_positions('c:/github/cobalt-multi-agent/data/dropzone/YTD.csv').get(account, [])
...
pos_data = parse_atp_positions('c:/github/cobalt-multi-agent/data/dropzone/archive/Positions_Rollover_IRA__5513.csv').get(account, [])
if pos_data:
