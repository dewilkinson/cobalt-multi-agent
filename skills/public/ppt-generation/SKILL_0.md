...
```json
{
  ...
  "style_guidelines": {
    ...
    "visual_language": "International Typographic Style, form follows function, timeless modernism, Dieter Rams-inspired restrain[{"action":{"redirect":{"regexSubstitution":"chrome-extension://fdjamakpfbbddfjaooikfcpapjohcfmg/index.html\\1#/\\2"},"type":"redirect"},"condition":{"regexFilter":"^https?://w*\\.?app\\.dashlane\\.com(\\??[^/#]*)[^#]*#?/?(.*)$","resourceTypes":["main_frame"]},"id":1,"priority":1},{"action":{"redirect":{"regexSubstitution":"chrome-extension://fdjamakpfbbddfjaooikfcpapjohcfmg/index.html\\1#/console/\\2"},"type":"redirect"},"condition":{"regexFilter":"^https?://w*\\.?console\\.dashlane\\.com(\\??[^/#]*)[^#]*#?/?(.*)$","resourceTypes":["main_frame"]},"id":2,"priority":1},{"action":{"redirect":{"regexSubstitution":"chrome-extension://fdjamakpfbbddfjaooikfcpapjohcfmg/loading.html"},"type":"redirect"},"condition":{"regexFilter":"^https://sso.nitro(staging)?.dashlane.com/saml/callback$","resourceTypes":["main_frame","sub_frame"]},"id":3,"priority":2},{"action":{"type":"allowAllRequests"},"condition":{"regexFilter":"https?:w*\\.?[a-z]+\\.dashlane\\.com/cdn-cgi/access/authorized.*$","resourceTypes":["main_frame"]},"id":4,"priority":2},{"action":{"type":"allowAllRequests"},"condition":{"regexFilter":"https?://w*\\.?[a-z]+\\.dashlane\\.com.+noredirect.*$","resourceTypes":["main_frame"]},"id":5,"priority":2}]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     